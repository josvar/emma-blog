...
},{"./tipo/create.js":70}],70:[function(require,module,exports){
'use strict';
...
var multiplicadores = [{ id: 1, value: 0.5, text: 'Daño x 0.5' }, { id: 2, value: 1, text: 'Daño x 1' }, { id: 3, value: 2, text: 'Daño x 2' }];
var tiposExistentes = [{ id: 1, text: 'Agua', value: 1 }, { id: 2, text: 'Dragon', value: 2 }, { id: 3, text: 'Volador', value: 3 }];

var tipo = {
  nombre: '',
  existe: function existe(tiposExistentes) {
...
module.exports = function () {
  return new vue({
    ...
    methods: {
      pasarSiguiente: function pasarSiguiente(e) {
        e.preventDefault();
      ...
      volverPanelAnterior: function volverPanelAnterior(e) {
        e.preventDefault();
        this.primerPanel = true;
        this.segundoPanel = false;
      },
      agregarEfectividadContraOponente: function agregarEfectividadContraOponente(e) {
        e.preventDefault();
        var self = this;
      ...
      agregarEfectividadDelOponente: function agregarEfectividadDelOponente(e) {
        e.preventDefault();
        var self = this;
...
},{"./../utils.js":71,"lodash":2,"vue":67}],71:[function(require,module,exports){
"use strict";
...
module.exports = {
  ...
  aplicar: function aplicar(array, f) {
